                            ...
                            <div class="align-items-center">
                                <div class="d-flex align-items-center">
                                    <img src="{{ !empty($profileData->photo) ? url('upload/user_images/' . $profileData->photo) : url('upload/no_image.jpg') }}"
                                        class="avatar-xxl img-thumbnail float-start" alt="image profile">
                                            ...
                                            <form action="{{ route('profile.store') }}" method="POST"
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-group mb-3 row">
                                                        ...
                                                        <div class="col-lg-12 col-xl-12">
                                                            <textarea class="form-control" name="address" id="validationTextarea" placeholder="Address">{{ $profileData->address }}</textarea>
                                                        </div>
                                                    </div>
                                                    <div class="form-group mb-3 row">
                                                    ...
                                                    <div class="form-group mb-3 row">
                                                        <div class="col-lg-12 col-xl-12">
                                                            <img id="showImage"
                                                                ...
                                                                class="avatar-xxl img-thumbnail float-start"
                                                                alt="image profile">
                                                        </div>
                                                    </div>
